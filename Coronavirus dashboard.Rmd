---
title: "Coronavirus in Tunisia"
author: "Ayoub Chouikha"
output:
...
valueBox(
  ...
  caption = "Active cases (active rate)",
...
### **Daily cumulative cases by type** (Tunisia only)
...
plotly::plot_ly(data = df_daily) %>%
  ...
  plotly::add_annotations(
    ...
    y = 1,
    text = paste("First recovery"),
    arrowcolor = recovered_color, 
    xref = "x",
    yref = "y",
    arrowhead = 5,
    arrowhead = 3,
...
Comparison with Arab Maghreb Union
=======================================================================
...
This [Coronavirus dashboard: the case of Tunisia](my dashboard) provides an overview of the 2019 Novel Coronavirus COVID-19 (2019-nCoV) epidemic for Tunisia. This dashboard is built with R using the R Makrdown framework and was adapted from this [dashboard](https://www.antoinesoetewey.com/files/coronavirus-dashboard.html){target="_blank"} by Antoine Soetewey which was also adapted from this [dashboard](https://ramikrispin.github.io/coronavirus_dashboard/){target="_blank"}

**Code**

The code behind this dashboard is available on [GitHub](my dashboard repository on github){target="_blank"}.
